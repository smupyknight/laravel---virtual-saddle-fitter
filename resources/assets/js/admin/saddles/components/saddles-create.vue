...
<script>
    export default {
        ...
        methods: {
            postCreate() {
                this.myAxios.post(this.saddlesResourceUrl, this.data)
                    .then((response) => {
                        this.showElementNotify('Saddle Created', 'New saddle has created.');
            ...
            getData() {
	            ...
	            this.myAxios.get(this.saddlesResourceUrl+'/create')
		            .then((res) => {
