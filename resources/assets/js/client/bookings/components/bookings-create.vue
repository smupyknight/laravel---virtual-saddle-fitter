        ...
        <div class="ibox-content" v-loading="XHRCount">
            <form class="form-horizontal">
                ...
                <div class="form-group" :class="{'has-error': errors.has('horse_id')}">
                    ...
                    <div class="col-md-10">
                        <select class="form-control" v-model="data.horse_id" id="horse_id" @change="onHorseChange(data.horse_id)">
...
<script>
    export default {
        ...
        methods: {
            ...
            getData() {
                // Get user info, set address field
                this.myAxios.get(this.userInfoResourceUrl)
                    .then((res) => {
