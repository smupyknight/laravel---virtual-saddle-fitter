    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <div class="ibox-tools">
                <router-link :to="{ name: 'riders-create'}" class="btn btn-primary btn-xs">Create a new Rider
                </router-link>
            </div>
        </div>
        <div class="ibox-content" v-loading="XHRCount">
            ...
            <table class="table table-bordered">
                ...
                <tr v-for="rider in riders">
                    ...
                    <td>
                        <router-link :to="{ name: 'riders-view', params: { id: rider.id } }"
                                     class="btn btn-info btn-xs"><i
                                class="fa fa-eye"></i></router-link>
                        <router-link :to="{ name: 'riders-edit', params: { id: rider.id } }"
                                     class="btn btn-primary btn-xs"><i class="fa fa-pencil-square"></i>
                        </router-link>
                        <button @click="onDelete(rider.id)" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i>
                        </button>
                    </td>
                </tr>
                </tbody>
        ...
        methods: {
            ...
            onDelete(id) {
                swal({
                    ...
                    .then((value) => {
                        if (value) {
                            this.myAxios.delete(this.ridersResourceUrl + '/' + id)
                                .then((response) => {
                                    this.showElementNotify('Rider Deleted', 'Rider deleted successfully!');
                                    this.getData();
                                })
                                .catch((error) => {
                                    console.log(error);
