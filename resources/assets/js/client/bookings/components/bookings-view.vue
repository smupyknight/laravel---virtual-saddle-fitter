    ...
    <div class="ibox float-e-margins">
        <div class="ibox-title">
            ...
            <div class="ibox-tools">
                ...
                <router-link :to="{ name: 'bookings-edit', params: { id: this.$route.params.id } }"
        ...
        <div class="ibox-content" v-loading="XHRCount">
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <label class="col-md-2 control-label">Fitter: </label>
                    <div class="col-md-4">
                        <p class="form-control-static"> {{ data.fitter.name }}</p>
                    </div>
